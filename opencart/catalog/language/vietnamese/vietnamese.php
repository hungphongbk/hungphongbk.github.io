...
$_['text_no']               = 'Không';
$_['text_none']             = ' --- Không --- ';
$_['text_select']           = ' --- Hãy lựa chọn --- ';
$_['text_all_zones']        = 'Tất cả các vùng';
$_['text_pagination']       = 'Hiển thị từ %d tới %d trong số %d (%d trang)';
$_['text_loading']          = 'Đang tải...';

// Buttons
$_['button_address_add']    = 'Thêm địa chỉ';
$_['button_back']           = 'Quay trỏ về';
...
$_['button_coupon']         = 'Sử dụng coupon';
$_['button_delete']         = 'Xoá';
...
$_['button_reviews']        = 'Phản hồi';
$_['button_write']          = 'Viết phản hồi';
...
$_['button_grid']           = 'Lưới';
$_['button_map']            = 'Xem trên Google Map';
